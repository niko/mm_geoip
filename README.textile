...
Easy as pie. Just @require 'rack/mm_geoip.rb'@ and then @use Rack::MMGeoip@.

h3. Sinatra

There is a helper for Sinatra. You just require it:

<pre><code>require 'sinatra/mm_geoip.rb'
</code></pre>
...
There also is a demo application with Sinatra available at "https://github.com/niko/mm_geoip_with_sinatra":https://github.com/niko/mm_geoip_with_sinatra. Try it at "http://mmgeoip.heroku.com/":http://mmgeoip.heroku.com/.
